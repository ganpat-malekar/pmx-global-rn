 ...
 * @returns {boolean}
 */
export const submitVendorMakePaymentData =
 ...
 * @returns {boolean}
 */
export const confirmVendorMakePaymentBookedPayments =
 ...
 * @returns {boolean}
 */
export const deleteVendorMakePaymentBookedTransactions =
  (data) => async (dispatch, getState) => {
    let responseData = null;
 ...
 * paymentsTableData: state.vendorMakePayment.paymentsTableData
 *
 * @param {Object} data - payload (MANDATORY)
 * @param {number} data.PaymentType - Plaintext, hardcoded - 1 for MakePayment (MANDATORY)
 * @returns {undefined}
 */
export const getVendorMakePaymentBookedTransactionsTableData =
  (data) => async (dispatch, getState) => {
    let responseData = null;
    ...
    dispatch({
      type: 'STORE_VENDOR_MAKE_PAYMENT_TABLE_DATA',
 ...
 * editData: state.vendorMakePayment.editData
 *
 * @param {Object} data - payload (MANDATORY)
 * @returns {undefined}
 */
export const storeVendorMakePaymentEditData =
  (data) => (dispatch, getState) => {
    dispatch({
      type: 'STORE_VENDOR_PAYMENT_EDIT_DATA',
      payload: data,
    });
  };
 ...
 * @returns {undefined}
 */
export const flushVendorMakePaymentEditData = () => (dispatch, getState) => {
  dispatch({
    type: 'FLUSH_VENDOR_PAYMENT_EDIT_DATA',
  });
};
