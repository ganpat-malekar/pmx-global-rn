...
export default function encryptAES(data, key = 'B987A8C9A8765BCAB987A8C9A8765BCA', iv = '54327CD65487ECAB') {
  let encodedKey = CryptoJS.enc.Utf8.parse(key);
  //let iv = str.substring(0, 16);
  let encodedIV = CryptoJS.enc.Utf8.parse(iv);
