...
function AddressProof(props) {
  ...
  const [showFileValidation, setShowFileValidation] = useState(true);
  ...
  useEffect(() => {
    if (props.AddressProofData) {
      ...
      if (props.AddressProofData.PaymateDocumentId) {
            ...
            <FormControl fullWidth>
              <TextField
                ...
                helperText={validator.message(
                  ...
                  "required|uae_branch_address_validator"
                )}
              />
            </FormControl>
          </Grid>
            ...
            <FormControl fullWidth>
              <TextField
                ...
                helperText={validator.message(
                  "PostalCode",
                  values.PostalCode,
                  "required|uae_postal_code_validator"
                )}
              />
